...
pr.push(/\Bуголовн\B/);
pr.push(/\Bконфликт\B/);
pr.push(/\Bэлекторат\B/);
pr.push(/\Bпротест\B/);
pr.push(/\Bоппозиц\B/);
pr.push(/\Bустойчив\B/);
pr.push(/\Bразвит\B/);
pr.push(/\Bклоун\B/);
pr.push(/\Bэкстремист\B/);
pr.push(/\Bтеррор\B/);
pr.push(/\Bблоггер\B/);
pr.push(/\Bолигарх\B/);
pr.push(/\Bинформационн\B/);
pr.push(/\Bкампания\B/);
pr.push(/\Bповестк\B/);
